...
import org.firstinspires.ftc.teamcode.opmodes.auton.trajectories.BlueClose9Trajectories;
...
@Configurable
@Autonomous(name = "Blue Close 9", preselectTeleOp = "RedMain")
public class BlueClose9 extends OpModeCore {
    ...
    private BlueClose9Trajectories trajectories;

    @Override
    public void initialize() {
        this.trajectories = new BlueClose9Trajectories();
