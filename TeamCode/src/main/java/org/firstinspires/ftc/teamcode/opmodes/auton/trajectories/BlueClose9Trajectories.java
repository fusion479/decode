...
@Configurable
public class BlueClose9Trajectories {
    ...
    public BlueClose9Trajectories() {
        this.poses = AutonomousHelpers.getPosesByName(new File("").getAbsolutePath().concat("/sdcard/FIRST/positions/BlueClose9.pp"));
