...
@Configurable
public class BlueFarOneLine15Trajectories {
    ...
    public BlueFarOneLine15Trajectories() {
        this.poses = AutonomousHelpers.getPosesByName(new File("").getAbsolutePath().concat("/sdcard/FIRST/positions/BlueFarOneLine15.pp"));
