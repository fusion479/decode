...
import org.firstinspires.ftc.teamcode.pedroPathing.ParametricCallback;
import com.pedropathing.paths.callbacks.PathCallback;
import org.firstinspires.ftc.teamcode.pedroPathing.PoseCallback;
...
public class PathBuilder {
     ...
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder addPath(Path path) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder addPath(Curve curve) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder addPaths(Path... paths){
        for (Path path: paths) {
            path.setConstraints(constraints);
            this.paths.add(path);
        }
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder addPaths(Curve... curves){
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder curveThrough(Pose prevPoint, Pose startPoint, double tension, Pose... points){
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder curveThrough(double tension, Pose... points){
        Pose prevPoint;
        Pose startPoint;
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setLinearHeadingInterpolation(double startHeading, double endHeading) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setGlobalLinearHeadingInterpolation(double startHeading, double endHeading) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setLinearHeadingInterpolation(double startHeading, double endHeading, double endTime) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setGlobalLinearHeadingInterpolation(double startHeading, double endHeading, double endTime) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setLinearHeadingInterpolation(double startHeading, double endHeading, double endTime, double startTime) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setGlobalLinearHeadingInterpolation(double startHeading, double endHeading, double endTime, double startTime) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setConstantHeadingInterpolation(double setHeading) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setGlobalConstantHeadingInterpolation(double setHeading) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setReversed() {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setGlobalReversed() {
     ...
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setTangentHeadingInterpolation() {
     ...
     * tangential but it's here.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setGlobalTangentHeadingInterpolation() {
     ...
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setHeadingInterpolation(HeadingInterpolator function) {
     ...
     * @param function A function that describes the target heading as a function of t, the parametric variable. Use a lambda expression here.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setGlobalHeadingInterpolation(HeadingInterpolator function) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setBrakingStrength(double set) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setBrakingStart(double set) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setVelocityConstraint(double set) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setTranslationalConstraint(double set) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setHeadingConstraint(double set) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setTValueConstraint(double set) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setTimeoutConstraint(double set) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder addTemporalCallback(double time, Runnable runnable) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder addParametricCallback(double t, Runnable runnable) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder addPoseCallback(Pose targetPoint, Runnable runnable, double initialTValueGuess) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder addCallback(PathCallback callback) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder addCallback(PathCallback callback, int i) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder addCallback(org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder.CallbackCondition condition, Runnable action) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder addCallback(org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder.CallbackCondition condition, Runnable action, int i) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder addLoopedCallback(PathCallback callback) {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setGlobalDeceleration() {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setGlobalDeceleration(double brakingStart) {
        this.decelerationType = PathChain.DecelerationType.GLOBAL;
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setNoDeceleration() {
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setConstraints(PathConstraints constraints) {
        this.constraints = constraints;
        return this;
    }
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setConstraintsForAll(PathConstraints constraints) {
        this.constraints = constraints;
        for (Path path : paths) {
            path.setConstraints(constraints);
        }
     ...
     * @return This returns itself with the updated data.
     */
    public org.firstinspires.ftc.teamcode.pedroPathing.PathBuilder setConstraintsForLast(PathConstraints constraints) {
        this.constraints = constraints;
